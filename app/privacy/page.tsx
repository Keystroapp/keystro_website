...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="mb-4">Last updated: May 12, 2024</p>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold my-4 ">Interpretation</h3>
      <p className="mb-4">
      ...
      <ul>
        ...
        <li>
          <p className="mb-4">
            <strong>Application</strong> refers to Keystro, the software program
        ...
        <li>
          <p className="mb-4">
            ...
            this Agreement) refers to Keystro.
          </p>
        </li>
        <li>
          <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold my-4 ">Types of Data Collected</h3>
      <h4 className="text-lg mb-4 font-bold">Personal Data</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg mb-4 font-bold">Usage Data</h4>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold my-4 ">Use of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold my-4 ">Delete Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h4 className="text-lg mb-4 font-bold">Business Transactions</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg mb-4 font-bold">Law enforcement</h4>
      <p className="mb-4">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-lg mb-4 font-bold">Other legal requirements</h4>
      <p className="mb-4">
      ...
      <ul>
        <li>
          ...
          >
            <p className="underline text-blue-500 mb-4">keystroapp@gmail.com</p>
          </Link>
        </li>
        <li>
          <p className="mb-4">
